    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_theme', models.CharField(choices=[('#dddcd7', 'Default (Gray)'), ('#e0ecf8', 'Blue'), ('#dbeed5', 'Green'), ('#fde4e4', 'Pink'), ('#eaf3d0', 'Yellow')], default='#dddcd7', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notif_type', models.CharField(choices=[('invite', 'Invitation'), ('join', 'Joining'), ('remove', 'Removed'), ('accepted', 'Accepted'), ('declined', 'Declined')], max_length=10)),
